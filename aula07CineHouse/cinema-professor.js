...
let catalogo = require('./database/catalogo2.json')
...
// E no caso dos atores, utilizando join, unimos os itens do array en uma única string,
...
console.log(alterarStatusEmCartazTernario(catalogo, 1))
